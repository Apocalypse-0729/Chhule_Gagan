        ...
        <div>
            <div className="container main-3 mt-5 rounded">
                ...
                <div class="col-md-12 content-7">
                    <div class="row g-0 border rounded-5 overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative content-img">
                        <div class="col-lg-6 p-4 d-flex flex-column content">
                        ...
                        <div class="col-lg-6 d-flex flex-column">
                            <img src={course} width="500" height="450" className="mt-5"/>
                        </div>
                    </div>
                </div>
            </div>
